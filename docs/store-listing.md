...
**「기프티콘」은 SK텔레콤의 등록상표지만 그대로 쓴다**(2026-09-13 확인,
store-release.md 6장). 09류에 앱이 들어 있어 자리는 겹치는데, 같은 업종 앱들이 이름에
넣고 살아 있고(App Store 「BuzzCon - 기프티콘 관리」) 걸고넘어진 사례가 없다.
사람들이 찾을 때 치는 말이라 빼는 쪽 손해가 더 크다.

앱 이름 `모아콘 - 가족 기프티콘 서랍`도 그대로 둔다.
