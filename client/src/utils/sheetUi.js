...
// 보조만 높이를 직접 들고 있다. 48 은 버튼 크기 토큰이 아니라 "시트 안에서 한 단
// 아래"라는 뜻의 값이라서다 — 주 버튼(xl · 52)과 나란히 설 때만 쓰인다.
export const SECONDARY_BUTTON =
  "h-12 w-full rounded-lg text-body font-semibold tracking-button text-foreground/80";
