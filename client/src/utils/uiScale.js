...
// 폰마다 기준이 다르다. 갤럭시는 4% 내리고, 아이폰은 9% 올린다.
//
...
// 1.07, 1.09로 다시 올라왔다.
//
// 한 번에 2%씩 올리는 동안 "바뀐 것 같지 않다"는 말을 들었다. 그럴 만하다 — 2%는
// 16px 글자가 16.3px 되는 것이라 나란히 놓고 대지 않으면 안 보인다. 눈으로 정하는
// 값을 눈에 안 보이는 폭으로 옮기면 옮긴 줄도 모른다. 다음에 또 만질 일이 있으면
// 한 번에 4% 이상 움직이고, 버전 줄의 숫자로 먼저 확인한다.
//
...
// 폰에 깔아서 정한다.
const PLATFORM_BASE = { android: 0.96, ios: 1.09 };
