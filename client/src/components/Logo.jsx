...
// 화면 안에서 쓰는 모아콘 마크. 런처 아이콘(assets/brand/icon-master.svg)과 그림은 같고
// 모서리만 여기서 직접 굴린다. iOS·안드로이드는 런처 아이콘 모서리를 알아서 깎아주지만
// 화면 안 로고는 아무도 안 깎아준다.
//
      ...
      <g transform="translate(256 256) scale(1)">
        <g transform="rotate(-9)">
          <path
            ...
            transform="translate(-221.72 66.00) scale(0.18462)"
            fill="#FFFFFF"
          />
          <circle
            cx="2.21"
          ...
          <path
            ...
            transform="translate(70.01 66.00) scale(0.18462)"
            fill="#FFFFFF"
          />
        </g>
      </g>
