  ...
  return (
    <header className="px-4 pt-[var(--safe-top)] pb-2.5">
      ...
      <div className="flex items-center gap-1.5">
        ...
        {/* 보이는 동그라미 38px, 누를 자리 44px.
            34px으로 시작했다가 "두세 번 눌러야 열린다"는 말을 듣고 누를 자리를 42px로
            넓혔고, 그다음엔 동그라미 자체가 작아 보인다고 해서 38px로 키웠다. 화면 맨
            오른쪽 끝이라 엄지가 조금만 밖으로 나가도 빗나가는 자리다.
            애플이 권하는 최소 과녁이 44pt라 누를 자리를 거기 맞췄다. */}
        <button
          type="button"
